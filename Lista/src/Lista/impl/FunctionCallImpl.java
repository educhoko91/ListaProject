 ...
 * <ul>
 *   <li>{@link Lista.impl.FunctionCallImpl#getArguments <em>Arguments</em>}</li>
 *   <li>{@link Lista.impl.FunctionCallImpl#getFunction <em>Function</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FunctionCallImpl extends ExpressionImpl implements FunctionCall {
	...
	protected EClass eStaticClass() {
		return ListaPackage.Literals.FUNCTION_CALL;
	}
		...
		if (function != null && function.eIsProxy()) {
			...
			if (function != oldFunction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ListaPackage.FUNCTION_CALL__FUNCTION, oldFunction, function));
			}
		}
		return function;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ListaPackage.FUNCTION_CALL__ARGUMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ListaPackage.FUNCTION_CALL__ARGUMENTS:
				return getArguments();
			case ListaPackage.FUNCTION_CALL__FUNCTION:

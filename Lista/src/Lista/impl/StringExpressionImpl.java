 ...
 * <ul>
 *   <li>{@link Lista.impl.StringExpressionImpl#getString <em>String</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringExpressionImpl extends ExpressionImpl implements StringExpression {
	...
	protected EClass eStaticClass() {
		return ListaPackage.Literals.STRING_EXPRESSION;
	}
	...
	public EList<String> getString() {
		if (string == null) {
			string = new EDataTypeUniqueEList<String>(String.class, this, ListaPackage.STRING_EXPRESSION__STRING);
		}
		return string;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ListaPackage.STRING_EXPRESSION__STRING:
				return getString();
		}

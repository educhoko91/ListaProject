...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Seq Expression</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link Lista.impl.SeqExpressionImpl#getSubExpressions <em>Sub Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SeqExpressionImpl extends ExpressionImpl implements SeqExpression {
	/**
	...
	protected EClass eStaticClass() {
		return ListaPackage.Literals.SEQ_EXPRESSION;
	}
	...
	public EList<Expression> getSubExpressions() {
		if (subExpressions == null) {
			subExpressions = new EObjectContainmentEList<Expression>(Expression.class, this, ListaPackage.SEQ_EXPRESSION__SUB_EXPRESSIONS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ListaPackage.SEQ_EXPRESSION__SUB_EXPRESSIONS:
